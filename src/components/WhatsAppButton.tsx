...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      // En bas à gauche, le bouton se posait sur l'onglet « Accueil » de la
      // barre mobile : il masquait une entrée de navigation, ce que rien ne
      // justifie pour un contact secondaire. Il passe à droite, et remonte
      // au-dessus de la barre — dont la hauteur inclut la zone sûre de l'écran
      // et le bouton « Diagnostic », qui dépasse vers le haut.
      // Sur grand écran la barre d'onglets n'existe pas : il redescend.
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+5.5rem)] right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary lg:bottom-6"
    >
